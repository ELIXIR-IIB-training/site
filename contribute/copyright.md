...
You are welcome to create the images yourself, but please follow the [site style guide](style-guide), and bear in mind the image may be modified to better suite the style of the site. The content of the site is published under the [Creative Commons 4 license](https://creativecommons.org/licenses/by/4.0/).
