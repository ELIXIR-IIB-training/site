 ...
 */
!function() {
    var t, l, c, h, d, f, p, y, m, g, x, v, w, Q, k, S, E, L, b, P, T, O, I, e, r, D = function(e) {
        var t = new D.Builder;
        return t.pipeline.add(D.trimmer, D.stopWordFilter, D.stemmer),
    ...
    function i(e) {
        var t, r, i, n, s, o, a, u;
        return e.length < 3 || ("y" == (r = e.substr(0, 1)) && (e = r.toUpperCase() + e.substr(1)),
        a = m,
        (s = y).test(e) ? e = e.replace(s, "$1$2") : a.test(e) && (e = e.replace(a, "$1$2")),
        a = x,
        (s = g).test(e) ? (u = s.exec(e),
        (s = h).test(u[1]) && (s = v,
        e = e.replace(s, ""))) : a.test(e) && (o = (u = a.exec(e))[1],
        (a = p).test(o) && (i = Q,
        n = k,
        (a = w).test(e = o) ? e += "e" : i.test(e) ? (s = v,
        e = e.replace(s, "")) : n.test(e) && (e += "e"))),
        (s = S).test(e) && (e = (o = (u = s.exec(e))[1]) + "i"),
        (s = E).test(e) && (o = (u = s.exec(e))[1],
        t = u[2],
        (s = h).test(o) && (e = o + l[t])),
        (s = L).test(e) && (o = (u = s.exec(e))[1],
        t = u[2],
        (s = h).test(o) && (e = o + c[t])),
        a = P,
        (s = b).test(e) ? (o = (u = s.exec(e))[1],
        (s = d).test(o) && (e = o)) : a.test(e) && (o = (u = a.exec(e))[1] + u[2],
        (a = d).test(o) && (e = o)),
        (s = T).test(e) && (o = (u = s.exec(e))[1],
        a = f,
        i = I,
        ((s = d).test(o) || a.test(o) && !i.test(o)) && (e = o)),
        a = d,
        (s = O).test(e) && a.test(e) && (s = v,
        e = e.replace(s, "")),
    ...
    D.FieldRef.fromString = function(e) {
        ...
        var r = e.slice(0, t)
          , t = e.slice(t + 1);
        return new D.FieldRef(t,r,e)
    }
    ,
    D.FieldRef.prototype.toString = function() {
        return null == this._stringValue && (this._stringValue = this.fieldName + D.FieldRef.joiner + this.docRef),
        this._stringValue
    }
    ,
    D.Set = function(e) {
    ...
    D.tokenizer = function(e, t) {
        ...
        for (var r = e.toString().toLowerCase(), i = r.length, n = [], s = 0, o = 0; s <= i; s++) {
            var a, u = s - o;
            !r.charAt(s).match(D.tokenizer.separator) && s != i || (0 < u && ((a = D.utils.clone(t) || {}).position = [o, u],
            a.index = n.length,
            n.push(new D.Token(r.slice(o, s),a))),
            o = s + 1)
        }
        return n
    }
    ...
    D.Pipeline.registerFunction = function(e, t) {
        t in this.registeredFunctions && D.utils.warn("Overwriting existing registered function: " + t),
        e.label = t,
    ...
    D.Pipeline.prototype.add = function() {
        Array.prototype.slice.call(arguments).forEach(function(e) {
            D.Pipeline.warnIfFunctionNotRegistered(e),
            this._stack.push(e)
        }, this)
    }
    ,
    ...
    D.Pipeline.prototype.toJSON = function() {
        return this._stack.map(function(e) {
            return D.Pipeline.warnIfFunctionNotRegistered(e),
            e.label
        })
    }
    ,
    ...
    D.Vector.prototype.positionForIndex = function(e) {
        if (0 == this.elements.length)
            return 0;
        for (var t = 0, r = this.elements.length / 2, i = r - t, n = Math.floor(i / 2), s = this.elements[2 * n]; 1 < i && (s < e && (t = n),
        e < s && (r = n),
        s != e); )
            i = r - t,
            n = t + Math.floor(i / 2),
            s = this.elements[2 * n];
        return s == e || e < s ? 2 * n : s < e ? 2 * (n + 1) : void 0
    }
    ,
    ...
    ,
    D.Vector.prototype.upsert = function(e, t, r) {
        this._magnitude = 0;
    ...
    D.Vector.prototype.dot = function(e) {
        for (var t, r, i = 0, n = this.elements, s = e.elements, o = n.length, a = s.length, u = 0, l = 0; u < o && l < a; )
            (t = n[u]) < (r = s[l]) ? u += 2 : r < t ? l += 2 : t == r && (i += n[u + 1] * s[l + 1],
            u += 2,
            l += 2);
        return i
    }
    ...
    D.Vector.prototype.toArray = function() {
        for (var e = new Array(this.elements.length / 2), t = 1, r = 0; t < this.elements.length; t += 2,
        r++)
            e[r] = this.elements[t];
        return e
    }
    ...
    D.TokenSet.fromArray = function(e) {
        for (var t = new D.TokenSet.Builder, r = 0, i = e.length; r < i; r++)
            t.insert(e[r]);
        return t.finish(),
        t.root
    }
    ...
    D.TokenSet.fromFuzzyString = function(e, t) {
        for (var r = new D.TokenSet, i = [{
            node: r,
            editsRemaining: t,
            str: e
        }]; i.length; ) {
            var n, s, o, a, u, l, c = i.pop();
            0 < c.str.length && ((u = c.str.charAt(0))in c.node.edges ? n = c.node.edges[u] : (n = new D.TokenSet,
            c.node.edges[u] = n),
            1 == c.str.length && (n.final = !0),
            i.push({
                node: n,
                editsRemaining: c.editsRemaining,
                str: c.str.slice(1)
            })),
            0 != c.editsRemaining && ("*"in c.node.edges ? s = c.node.edges["*"] : (s = new D.TokenSet,
            c.node.edges["*"] = s),
            0 == c.str.length && (s.final = !0),
            i.push({
                node: s,
                editsRemaining: c.editsRemaining - 1,
                str: c.str
            }),
            1 < c.str.length && i.push({
                node: c.node,
                editsRemaining: c.editsRemaining - 1,
                str: c.str.slice(1)
            }),
            1 == c.str.length && (c.node.final = !0),
            1 <= c.str.length && ("*"in c.node.edges ? o = c.node.edges["*"] : (o = new D.TokenSet,
            c.node.edges["*"] = o),
            1 == c.str.length && (o.final = !0),
            i.push({
                node: o,
                editsRemaining: c.editsRemaining - 1,
                str: c.str.slice(1)
            })),
            1 < c.str.length && (a = c.str.charAt(0),
            (u = c.str.charAt(1))in c.node.edges ? l = c.node.edges[u] : (l = new D.TokenSet,
            c.node.edges[u] = l),
            1 == c.str.length && (l.final = !0),
            i.push({
                node: l,
                editsRemaining: c.editsRemaining - 1,
                str: a + c.str.slice(2)
    ...
    D.TokenSet.fromString = function(e) {
        for (var t = new D.TokenSet, r = t, i = 0, n = e.length; i < n; i++) {
            var s, o = e[i], a = i == n - 1;
            "*" == o ? (t.edges[o] = t).final = a : ((s = new D.TokenSet).final = a,
            t.edges[o] = s,
            t = s)
        }
        return r
    ...
    D.TokenSet.prototype.intersect = function(e) {
        for (var t = new D.TokenSet, r = void 0, i = [{
            qNode: e,
            output: t,
            node: this
        }]; i.length; ) {
            ...
            for (var n = Object.keys(r.qNode.edges), s = n.length, o = Object.keys(r.node.edges), a = o.length, u = 0; u < s; u++)
                for (var l = n[u], c = 0; c < a; c++) {
                    var h, d, f, p, y = o[c];
                    y != l && "*" != l || (h = r.node.edges[y],
                    d = r.qNode.edges[l],
                    f = h.final && d.final,
                    p = void 0,
                    y in r.output.edges ? (p = r.output.edges[y]).final = p.final || f : ((p = new D.TokenSet).final = f,
                    r.output.edges[y] = p),
                    i.push({
                        qNode: d,
                        output: p,
    ...
    D.TokenSet.Builder.prototype.minimize = function(e) {
        for (var t = this.uncheckedNodes.length - 1; e <= t; t--) {
            var r = this.uncheckedNodes[t]
              , i = r.child.toString();
            i in this.minimizedNodes ? r.parent.edges[r.char] = this.minimizedNodes[i] : (r.child._str = i,
    ...
    D.Index.prototype.query = function(e) {
        for (var t = new D.Query(this.fields), r = Object.create(null), i = Object.create(null), n = Object.create(null), s = Object.create(null), o = Object.create(null), a = 0; a < this.fields.length; a++)
            i[this.fields[a]] = new D.Vector;
        e.call(t, t);
        for (a = 0; a < t.clauses.length; a++) {
            for (var u = t.clauses[a], l = null, c = D.Set.empty, l = u.usePipeline ? this.pipeline.runString(u.term, {
                fields: u.fields
            }) : [u.term], h = 0; h < l.length; h++) {
                var d = l[h];
                u.term = d;
                var d = D.TokenSet.fromClause(u)
                  , f = this.tokenSet.intersect(d).toArray();
                if (0 === f.length && u.presence === D.Query.presence.REQUIRED) {
                    for (var p = 0; p < u.fields.length; p++)
                        s[P = u.fields[p]] = D.Set.empty;
                    break
                }
                for (var y = 0; y < f.length; y++)
                    for (var m = f[y], g = this.invertedIndex[m], x = g._index, p = 0; p < u.fields.length; p++) {
                        var v = g[P = u.fields[p]]
                          , w = Object.keys(v)
                          , Q = m + "/" + P
                          , k = new D.Set(w);
                        if (u.presence == D.Query.presence.REQUIRED && (c = c.union(k),
                        void 0 === s[P] && (s[P] = D.Set.complete)),
                        u.presence != D.Query.presence.PROHIBITED) {
                            if (i[P].upsert(x, u.boost, function(e, t) {
                                return e + t
                            }),
                            !n[Q]) {
                                for (var S = 0; S < w.length; S++) {
                                    var E = w[S]
                                      , L = new D.FieldRef(E,P)
                                      , b = v[E];
                                    void 0 === (E = r[L]) ? r[L] = new D.MatchData(m,P,b) : E.add(m, P, b)
                                }
                                n[Q] = !0
                            }
                        } else
                            void 0 === o[P] && (o[P] = D.Set.empty),
                            o[P] = o[P].union(k)
                    }
            }
            if (u.presence === D.Query.presence.REQUIRED)
                for (p = 0; p < u.fields.length; p++)
                    s[P = u.fields[p]] = s[P].intersect(c)
        }
        for (var P, T = D.Set.complete, O = D.Set.empty, a = 0; a < this.fields.length; a++)
            s[P = this.fields[a]] && (T = T.intersect(s[P])),
            o[P] && (O = O.union(o[P]));
        var I = Object.keys(r)
          , R = []
        ...
        if (t.isNegated()) {
            ...
            for (a = 0; a < I.length; a++) {
                var L = I[a]
                  , C = D.FieldRef.fromString(L);
                r[L] = new D.MatchData
            }
        }
        for (a = 0; a < I.length; a++) {
            var N, j, _ = (C = D.FieldRef.fromString(I[a])).docRef;
            T.contains(_) && (O.contains(_) || (N = this.fieldVectors[C],
            j = i[C.fieldName].similarity(N),
            void 0 !== (N = F[_]) ? (N.score += j,
            N.matchData.combine(r[C])) : (j = {
                ref: _,
                score: j,
                matchData: r[C]
            },
    ...
    D.Index.load = function(e) {
        var t = {}
          ...
          , s = e.invertedIndex
          , o = new D.TokenSet.Builder
          , a = D.Pipeline.load(e.pipeline);
    ...
    D.Builder.prototype.add = function(e, t) {
        ...
        for (var n = 0; n < i.length; n++) {
            var s = i[n]
              ...
              , o = new D.FieldRef(r,s)
              , u = Object.create(null);
            this.fieldTermFrequencies[o] = u,
            this.fieldLengths[o] = 0,
            this.fieldLengths[o] += a.length;
            for (var l = 0; l < a.length; l++) {
                var c = a[l];
                if (null == u[c] && (u[c] = 0),
                u[c] += 1,
                null == this.invertedIndex[c]) {
                    var h = Object.create(null);
                    h._index = this.termIndex,
                    this.termIndex += 1;
                    for (var d = 0; d < i.length; d++)
                        h[i[d]] = Object.create(null);
                    this.invertedIndex[c] = h
                }
                null == this.invertedIndex[c][s][r] && (this.invertedIndex[c][s][r] = Object.create(null));
                for (var f = 0; f < this.metadataWhitelist.length; f++) {
                    var p = this.metadataWhitelist[f]
                      , y = c.metadata[p];
                    null == this.invertedIndex[c][s][r][p] && (this.invertedIndex[c][s][r][p] = []),
                    this.invertedIndex[c][s][r][p].push(y)
                }
            }
        }
    }
    ...
    D.Builder.prototype.calculateAverageFieldLengths = function() {
        for (var e = Object.keys(this.fieldLengths), t = e.length, r = {}, i = {}, n = 0; n < t; n++) {
            var s = D.FieldRef.fromString(e[n])
              , o = s.fieldName;
            i[o] || (i[o] = 0),
            i[o] += 1,
            r[o] || (r[o] = 0),
    ...
    D.Builder.prototype.createFieldVectors = function() {
        for (var e = {}, t = Object.keys(this.fieldTermFrequencies), r = t.length, i = Object.create(null), n = 0; n < r; n++) {
            for (var s = D.FieldRef.fromString(t[n]), o = s.fieldName, a = this.fieldLengths[s], u = new D.Vector, l = this.fieldTermFrequencies[s], c = Object.keys(l), h = c.length, d = this._fields[o].boost || 1, f = this._documents[s.docRef].boost || 1, p = 0; p < h; p++) {
                var y, m = c[p], g = l[m], x = this.invertedIndex[m]._index;
                void 0 === i[m] ? (y = D.idf(this.invertedIndex[m], this.documentCount),
                i[m] = y) : y = i[m],
                g = y * ((this._k1 + 1) * g) / (this._k1 * (1 - this._b + this._b * (a / this.averageFieldLength[o])) + g),
                g *= d,
                g *= f,
    ...
    ,
    D.MatchData.prototype.add = function(e, t, r) {
    ...
    D.Query.prototype.clause = function(e) {
        ...
        e.wildcard & D.Query.wildcard.LEADING && e.term.charAt(0) != D.Query.wildcard && (e.term = "*" + e.term),
        e.wildcard & D.Query.wildcard.TRAILING && e.term.slice(-1) != D.Query.wildcard && (e.term = e.term + "*"),
    ...
    D.Query.prototype.term = function(e, t) {
        if (Array.isArray(e))
            ...
            this;
        var r = t || {};
        return r.term = e.toString(),
        this.clause(r),
        this
    }
    ,
    D.QueryParseError = function(e, t, r) {
    ...
    D.QueryLexer.prototype.run = function() {
        for (var e = D.QueryLexer.lexText; e; )
            e = e(this)
    }
    ,
    ...
    D.QueryLexer.prototype.acceptDigitRun = function() {
        for (var e, t; t = (e = this.next()).charCodeAt(0),
        47 < t && t < 58; )
            ;
    ...
    D.QueryLexer.lexTerm = function(e) {
        if (1 < e.width() && (e.backup(),
        e.emit(D.QueryLexer.TERM)),
        e.ignore(),
        e.more())
    ...
    D.QueryLexer.lexText = function(e) {
        for (; ; ) {
            var t = e.next();
            if (t == D.QueryLexer.EOS)
                return D.QueryLexer.lexEOS;
            if (92 != t.charCodeAt(0)) {
                if (":" == t)
                    return D.QueryLexer.lexField;
                if ("~" == t)
                    return e.backup(),
                    0 < e.width() && e.emit(D.QueryLexer.TERM),
                ...
                if ("+" == t && 1 === e.width())
                    return e.emit(D.QueryLexer.PRESENCE),
                    D.QueryLexer.lexText;
                if ("-" == t && 1 === e.width())
                    return e.emit(D.QueryLexer.PRESENCE),
                    D.QueryLexer.lexText;
    ...
    D.QueryParser.prototype.parse = function() {
        ...
        for (var e = D.QueryParser.parseClause; e; )
            e = e(this);
        return this.query
    }
    ,
    ...
    D.QueryParser.parseClause = function(e) {
        ...
        if (null != t)
            ...
            default:
                ...
                new D.QueryParseError(r,t.start,t.end)
            }
    }
    ,
        ...
        if (null != t) {
            if (-1 == e.query.allFields.indexOf(t.str)) {
                var r = e.query.allFields.map(function(e) {
                  ...
                  , r = "unrecognised field '" + t.str + "', possible fields: " + r;
                throw new D.QueryParseError(r,t.start,t.end)
            }
            ...
            if (e.type === D.QueryLexer.TERM)
                return D.QueryParser.parseTerm;
            r = "expecting term, found '" + e.type + "'";
            throw new D.QueryParseError(r,e.start,e.end)
        }
    }
    ,
    D.QueryParser.parseTerm = function(e) {
        ...
        if (null != t) {
            ...
            if (null != r)
                ...
                case D.QueryLexer.TERM:
                    return e.nextClause(),
                    D.QueryParser.parseTerm;
                case D.QueryLexer.FIELD:
                    return e.nextClause(),
                    D.QueryParser.parseField;
                ...
                case D.QueryLexer.PRESENCE:
                    return e.nextClause(),
                    D.QueryParser.parsePresence;
                default:
                    var i = "Unexpected lexeme type '" + r.type + "'";
                    throw new D.QueryParseError(i,r.start,r.end)
                }
            else
                e.nextClause()
        }
    ...
    D.QueryParser.parseEditDistance = function(e) {
        ...
        if (null != t) {
            ...
            if (isNaN(r)) {
                ...
                throw new D.QueryParseError(i,t.start,t.end)
            }
            ...
            if (null != n)
                ...
                default:
                    ...
                    throw new D.QueryParseError(i,n.start,n.end)
                }
            else
                e.nextClause()
        }
    ...
    ,
    "function" == typeof define && define.amd ? define(r) : "object" == typeof exports ? module.exports = D : e.lunr = D
}();
