...
{% include image.html file="/2022_and_older/Logo_B_and_Gu.jpg" alt="Logo_B_and_Gu" max-width="5" %}
{% include image.html file="/2022_and_older/logo_mbc_torino.jpeg" alt="logo_mbc_torino" max-width="5" %}
{% include image.html file="/2022_and_older/logo_bits.png" alt="logo_bits" max-width="5" %}
{% include image.html file="/2022_and_older/logo_hpc4ai.png" alt="logo_hpc4ai" max-width="5" %}
{% include image.html file="/2022_and_older/logo_10xgenomics.png" alt="logo_10xgenomics" max-width="5" %}
{% include image.html file="/2022_and_older/logo_euroclone.png" alt="logo_euroclone" max-width="5" %}
{% include image.html file="/2022_and_older/Logo_InfoLife.png" alt="Logo_InfoLife" max-width="5" %}
{% include image.html file="/2022_and_older/logo_iib.png" alt="logo_iib" max-width="5" %}
